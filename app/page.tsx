			...
			<section className="w-full px-6">
				<motion.div
					...
					<div className="w-full md:w-1/2 relative">
						...
						<div className="absolute top-10 right-10 w-16 h-16 bg-primary rounded-full -z-10 opacity-60 blur-xl"></div>
						<div className="absolute bottom-10 left-10 w-24 h-24 bg-secondary rounded-full -z-10 opacity-60 blur-xl"></div>
					</div>
				</motion.div>
			</section>
