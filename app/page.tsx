...
const howItWorks = [
  ...
  },
  {
    ...
    description:
      "Players join your quiz by entering a unique game code on their devices.",
    icon: "🔢",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description:
      "Top performers win cUSD rewards sent directly to their connected wallets.",
    icon: "💰",
  },
];
      ...
      <section className="flex flex-col items-center justify-center gap-8 pt-10 md:pt-24 px-4">
        ...
        >
          ...
          <h2 className={title({ size: "md" })}>
            Win <span className={title({ color: "green" })}>Crypto</span> With
            Your Knowledge
          </h2>
          <p className={subtitle({ class: "mt-4 md:w-3/4 mx-auto" })}>
            The multiplayer quiz platform where knowledge pays off. Create
            quizzes, compete in real-time, and win cryptocurrency rewards.
          </p>
        </motion.div>
        ...
        >
          <div className="w-full md:w-1/2 space-y-6">
            ...
            <p className={subtitle({ class: "!w-full mt-6" })}>
              Experience the excitement of BrainiacWiz with our demo quiz. Test
              your knowledge, see your score, and learn how easy it is to
              participate.
            </p>
      ...
      <section className="w-full px-6">
        ...
        >
          ...
          <p className={subtitle({ class: "!w-full mb-8 md:w-3/4 mx-auto" })}>
            Join thousands of players earning crypto rewards for their
            knowledge. Create your first quiz or join an existing game.
          </p>
                  ...
                  <CardBody>
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-default-500">@quizuser{i}</p>
                      </div>
                    </div>
